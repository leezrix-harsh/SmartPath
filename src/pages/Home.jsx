...
export default function Home() {
  ...
  const educators = [
    { name: 'Ms. Weda Setivani', subject: 'Biology', rating: 4.9, students: 850, avatar: '👩‍🔬' },
    ...
    { name: 'Mr. Oktav Gany', subject: 'Mathematics', rating: 5.0, students: 1200, avatar: '👨‍🏫' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <section className="relative overflow-hidden text-center py-16">
        ...
        <div className="relative max-w-4xl mx-auto px-4">
          ...
          >
            SmartPath provides high-quality learning materials, AI-powered tutoring, and direct access to expert educators. 
        ...
        <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:flex lg:items-center lg:justify-between lg:py-20 lg:px-8">
          <div className="lg:w-1/2 opacity-0 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            <h2 className="text-3xl font-extrabold text-white sm:text-4xl">
              ...
              <span className="block text-indigo-100">Join SmartPath today.</span>
            </h2>
      ...
      <footer className="bg-white">
        <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
          ...
          <p className="mt-8 text-center text-base text-gray-400">
            &copy; {new Date().getFullYear()} SmartPath. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
